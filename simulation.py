...
class ln_cells:
    ...
    def __init__(self,k1=0.125,k_in_T=0.082,diffusivity=10,contact_dist=12,r_paracortex=300,k_off=0.125,n_tot_Tconv_ln=3.e5,n_apc=1500,ag_specific_frequency=5.e-5,n_tot_Tconv=2.e7,mode='vanHeijst'):
        self.n_ln_apc=0
...
simulation=ln_cells(n_apc=100,diffusivity=1000)
# n_steps=2500
